					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<?php
								...
								$select = "SELECT client.client_id,client.uname,client.phone,cars.car_name,cars.hire_cost,client.status FROM client JOIN cars ON client.car_id=cars.car_id";
							...
							<tr>
								...
								<td><?php echo $row['hire_cost'] ?></a></td>
